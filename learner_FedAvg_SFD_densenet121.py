...
import pandas as pd
import os
from client_FedAvg_SFD_densenet121 import Client
import random

class Metanet(nn.Module):
  def __init__(self, device,local_metatrain_epoch=1, local_test_epoch=3,outer_lr=0.001,inner_lr=0.001):
    ...
    self.last_path = '/0529_1_FedAvg_SFD_densenet121'#-----------------------------------------------------
  ...
  def meta_training(self,round):
    ...
    id_train = random.sample(id_train_0, int(len(id_train_0)*0.2)) #clients of this round
